          ...
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div className="col-span-full">
                  <UploadField label="Image" name="image" formik={formik} />
                </div>
              </div>
            </div>
            <ImpactDataFields />
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div className="sm:col-span-4">
                  <label htmlFor="certificates" className="block text-sm font-medium leading-6 text-gray-900">
                    Certificates
                  </label>
                  <div className="mt-2">
                    <SelectField
                ...
                <div className="col-span-full">
                  <UploadField label="Attachments" name="attachments" formik={formik} />
                </div>
              </div>
            </div>
          </div>
